...
#define ACS_DISABLED  0x00000004
	...
	IDSEXP   is_IsVideoFinish(HIDS hCam, INT* ist_positionalue);
	...
	IDSEXP is_SetAutoParameter(HIDS hCam, INT param, double *ist_positional1, double *ist_positional2);
...
#pragma pack(push, 1)
	...
	// IP V4 address
	typedef union _UEYE_ETH_ADDR_Iist_position4
	{
		struct
		{
			BYTE  by1;
	...
	} UEYE_ETH_ADDR_Iist_position4, *PUEYE_ETH_ADDR_Iist_position4;
	...
	{
		UEYE_ETH_ADDR_Iist_position4    ipAddress;      /*!< IP address */
		UEYE_ETH_ADDR_Iist_position4    ipSubnetmask;   /*!< IP subnetmask */
	...
	typedef struct _UEYE_ETH_DEVICE_INFO_HEARTBEAT
	{
		...
		UEYE_ETH_ADDR_Iist_position4    ipPairedHostIp;             /*!< \brief paired host's IP address */

		UEYE_ETH_ADDR_Iist_position4    ipAutoCfgIpRangeBegin;      /*!< \brief begin of IP address range */

		UEYE_ETH_ADDR_Iist_position4    ipAutoCfgIpRangeEnd;        /*!< \brief end of IP address range */
	...
	{
		UEYE_ETH_ADDR_Iist_position4    ipAutoCfgIpRangeBegin;      /*!< begin of ip address range for devices */
		UEYE_ETH_ADDR_Iist_position4    ipAutoCfgIpRangeEnd;        /*!< end of ip address range for devices */
...
#define IS_GAMMA_VALUE_MAX          1000
	...
	*/
	...
	typedef struct
	{
		UEYE_ETH_ADDR_Iist_position4 ipCamera;
		UEYE_ETH_ADDR_Iist_position4 ipMulticast;
		UINT u32CameraId;
