...
Motor::Motor(int Index)
{
	...
	case 3: Var_Error[15] = Var_Reset[15] = Var_CurPosition[14] = Var_GetWorkingMode[15] = Var_SetWorkingMode[15] =
		...
		//Spindel modus change im Hollowshaftmotor
	...
	//Change working mode for each Motor
	// WorkingMode
	// 0 - Jog
	// 1 - Manuell
	// 2 - Automatisch
	...
	do {
		...
		do {
			...
			case 2:
				...
				break;
			default:
				cout << "Error. Working Mode cannot be identify" << endl;
			}
...
//GoToPosition Function consist State Machine
