...
public:
	...
	//char	  Var_Reset[23];
	//char	  Var_Error[23];
	//char	  Var_CurPosition[37];
	//char	  Var_SetPosition[37];
	//char	  Var_Enable[24];
	//char 	  Var_Disable[25];
	//char	  Var_Position[26];
	//char	  Var_Velocity[26];
	//char	  Var_Move_Start[28];
	//char	  Var_Move_Stop[27];
	//char	  Var_MovetoReference[33];
	//char	  Var_is_Enable[27];
	//char	  Var_is_Homed[26];
	//char	  Var_in_Position[29];
	//char	  Var_is_Moving[27];
	//	char	  Var_GetAxisMode[29];
	//	char	  Var_SetAxisMode[29];
	//char	  Var_GetWorkingMode[32];
	//	char	  Var_SetWorkingMode[32];
